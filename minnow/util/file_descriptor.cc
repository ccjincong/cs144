...
void FileDescriptor::read (vector<unique_ptr < string>>
...
non_blocking_ and(errno

== EAGAIN or errno == EINPROGRESS )) {
return;
}
throw unix_error {
"read" };
